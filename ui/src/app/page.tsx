  ...
  return (
    <div className="container mx-auto px-4 py-8 max-w-4xl">
      <header className="text-center mb-12">
        <h1 className="text-4xl font-bold text-blue-600 mb-2">B2B Link</h1>
        <p className="text-xl text-gray-600">Secure B2B File Sharing</p>
      </header>
      ...
      <footer className="mt-12 text-center text-gray-500 text-sm">
        <p>
          B2BLink &copy; {new Date().getFullYear()} - Secure B2B File Sharing
        </p>
      </footer>
    </div>
  );
